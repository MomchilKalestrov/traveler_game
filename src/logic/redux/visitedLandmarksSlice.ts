...
export const visitedLandmarksSlice = createSlice({
...
export const { add, remove, clear, update } = visitedLandmarksSlice.actions;
export default visitedLandmarksSlice.reducer;